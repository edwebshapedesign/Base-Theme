<?php
/**
 * Category Archive Template — Lumisol
 *
 * Displays all posts assigned to a single category. Uses the same
 * archive-grid + archive-card markup as blog-archive.html but pulls
 * live data through The Loop. No filter bar, no pagination.
 *
 * Drop into a WordPress theme alongside header.php / footer.php
 * (typically built from index.html's <header> and <footer> blocks).
 */
get_header();
...
<section class="page-hero">
  <div class="container">
    ...
    <?php if ( category_description() ) : ?>
      <div class="page-hero__intro"><?php echo wp_kses_post( category_description() ); ?></div>
    <?php else : ?>
      <p class="page-hero__intro">All Lumisol posts filed under <?php single_cat_title( '', true ); ?>.</p>
    <?php endif; ?>
  </div>
</section>
  ...
  <div class="container">
    ...
    <?php else : ?>
      ...
      <div class="archive-empty is-shown">
        <p><strong>No posts in this category yet.</strong></p>

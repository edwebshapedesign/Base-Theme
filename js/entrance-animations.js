/* ==========================================================================
   ...
   ========================================================================== */
(function () {
  // Mark the document so the CSS hidden-state applies. This file is loaded in
  // the footer, so header.php ALSO adds this class inline in <head> to stop a
  // flash of content before hiding kicks in. Kept here as a fallback.
  document.documentElement.classList.add('has-anim');

  var prefersReduced = window.matchMedia('(prefers-reduced-motion: reduce)').matches;

  var SELECTOR = [
    '[data-animate]' /* opt-in hook for blocks — add data-animate to any element */,
    '.section-head',
    '.intro',
    '.cta-banner',
    '.accreditations__row',
